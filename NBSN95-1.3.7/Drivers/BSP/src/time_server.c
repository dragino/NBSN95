...
RTC_TimeStructure.Hours = iH;
RTC_TimeStructure.Minutes = iMin;
RTC_TimeStructure.Seconds = iS;
HAL_RTC_SetTime(&hrtc,&RTC_TimeStructure, RTC_FORMAT_BIN);	
RTC_DateStructure.Date = iD;
RTC_DateStructure.Month =  iM;
RTC_DateStructure.Year =  iY-2000;
