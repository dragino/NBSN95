...
static const struct ATCommand_s ATCommand[] =
{
	...
	/** AT+DEUI **/	
  {
	...
	{
    .string = AT GDNS,
		.size_string = sizeof(GDNS) - 1,
#ifndef NO_HELP
    .help_string = AT GDNS "  : Get or Set the DNS ",
#endif
    .get = at_gdns_get,
    .set = at_gdns_set,
    .run = at_return_error,
	...
	{
    .string = AT IPTYPE,
		.size_string = sizeof(IPTYPE) - 1,
#ifndef NO_HELP
    .help_string = AT IPTYPE "  : Set the IPv4 or IPv6",
#endif
    .get = at_iptype_get,
    .set = at_iptype_set,
    .run = at_return_error,
	...
	{
	  .string = AT URI5,
    .size_string = sizeof(AT URI5) - 1,
#ifndef NO_HELP
    .help_string = AT URI5 ": Get or set CoAP option 5",
#endif
    .get = at_uri5_get,
    .set = at_uri5_set,
    .run = at_return_error,
	...
	{
    .string = AT QSW,
		.size_string = sizeof(QSW) - 1,
#ifndef NO_HELP
    .help_string = AT QSW "  : Power on and power off BG95 module",
#endif
    .get = at_return_error,
    .set = at_return_error,
    .run = at_qsw_run,
	...
	{
    .string = AT GNSST,
		.size_string = sizeof(GNSST) - 1,
#ifndef NO_HELP
    .help_string = AT GNSST "  : Extend the time to turn on GNSS",
#endif
    .get = at_gnsst_get,
    .set = at_gnsst_set,
    .run = at_return_error,
	...
	{
    .string = AT GPS,
		.size_string = sizeof(GPS) - 1,
#ifndef NO_HELP
    .help_string = AT GPS "  : Turn off and on GPS",
#endif
    .get = at_gps_get,
    .set = at_gps_set,
    .run = at_return_error,
	...
	{
    .string = AT GTDC,
		.size_string = sizeof(GTDC) - 1,
#ifndef NO_HELP
    .help_string = AT GTDC "     : Get or set GPS positioning interval in units of h",
#endif
    .get = at_gtdc_get,
    .set = at_gtdc_set,
    .run = at_return_error,
	...
	{
	  .string = AT QBAND,
    .size_string = sizeof(AT QBAND) - 1,
#ifndef NO_HELP
    .help_string = AT QBAND ": Get or set Frequency Band",
#endif
    .get = at_qband_get,
    .set = at_qband_set,
    .run = at_return_error,
	...
	{
	  .string = AT IOTMOD,
    .size_string = sizeof(AT IOTMOD) - 1,
#ifndef NO_HELP
    .help_string = AT IOTMOD ": Configure Network Category to be Searched for under LTE RAT",
#endif
    .get = at_iotmod_get,
    .set = at_iotmod_set,
    .run = at_return_error,
