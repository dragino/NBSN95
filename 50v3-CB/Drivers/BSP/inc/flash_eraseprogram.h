...
#define FLASH_USER_COAP_URI6            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*98)
#define FLASH_USER_COAP_URI7            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*99)
#define FLASH_USER_COAP_URI8            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*100)
#define FLASH_USER_COAP_END            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*101)
