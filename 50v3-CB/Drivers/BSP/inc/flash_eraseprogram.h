 ...
 * @retval None
 */
#define FLASH_USER_START_ADDR_CONFIG   (FLASH_BASE + FLASH_PAGE_SIZE * 1200)        					/* Start @ of user Flash area store config */
...
#define FLASH_USER_START_PASSWORD  (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*10)
#define FLASH_USER_END             (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*11)
#define FLASH_USER_COAP_URI1            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*93)
#define FLASH_USER_COAP_URI2             (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*94)
#define FLASH_USER_COAP_URI3             (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*95)
#define FLASH_USER_COAP_URI4            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*96)
#define FLASH_USER_COAP_URI5            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*97)

#define FLASH_USER_COAP_END            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*98)
#define FLASH_USER_NTP                (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*98)
#define FLASH_USER_NTP_END                (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*99)

#define FLASH_USER_START_DATALOG            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*12)
#define FLASH_USER_END_DATALOG            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*92)
#define FLASH_USER_BAND_START            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*101)
#define FLASH_USER_BAND_END            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*102)
#define FLASH_USER_DNSCFG            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*102)
#define FLASH_USER_DNSCFG_END            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*103)

#define FLASH_OTA_ADDR         (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*291)
#define FLASH_OTA_END_ADDR     (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*293)
...
#define EEPROM_USER_SLEEP_FLAG			    (EEPROM_USER_START_FDR_FLAG + 0x04)
