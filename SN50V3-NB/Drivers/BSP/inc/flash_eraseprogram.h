...
#define FLASH_USER_COAP_END            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*97)
#define FLASH_USER_DNSCFG            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*97)
#define FLASH_USER_DNSCFG_END            (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*98)
...
#define FLASH_OTA_ADDR         (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*288)
#define FLASH_OTA_END_ADDR     (FLASH_USER_START_ADDR_CONFIG + FLASH_PAGE_SIZE*290)
