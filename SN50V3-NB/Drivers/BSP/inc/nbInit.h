...
/*TCP*/	
	...
	_AT_QSSLCACERT,//MQTT Configure CA certificate.
	_AT_QSSLCCERT,//MQTT Configure client certificate.
	_AT_QSSLKEY,//MQTT Configure client private key.
...
/**************** QSSLCACERT	****************/
	{		
		...
		.ATRecStrOK  		= ">",
		.ATRecStrError  = "ERROR",
		.cmd_num        = _AT_QSSLCACERT,

		.time_out 			= 500,

    .run 						= nb_QSSLCACERT_run,
		.set						= nb_QSSLCACERT_set,
		.get						= nb_null_run,
...
/**************** QSSLCCERT	****************/
	{		
		...
		.ATRecStrOK  		= ">",
		.ATRecStrError  = "ERROR",
		.cmd_num        = _AT_QSSLCCERT,

		.time_out 			= 500,

    .run 						= nb_QSSLCCERT_run,
		.set						= nb_QSSLCCERT_set,
		.get						= nb_null_run,
