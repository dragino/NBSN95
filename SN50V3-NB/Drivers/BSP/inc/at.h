...
#define CLICERT     "+CLICERT"
#define CLIKEY     "+CLIKEY"
...
static const struct ATCommand_s ATCommand[] =
{
	...
	/** AT+DEUI **/	
  {
	...
	{
    .string = AT CACERT,
		.size_string = sizeof(CACERT) - 1,
#ifndef NO_HELP
    .help_string = AT CACERT "  : Configure CA certificate. ",
#endif
    .get = at_return_error,
    .set = at_return_error,
    .run = at_cacert_run,
	...
	{
    .string = AT CLICERT,
		.size_string = sizeof(CLICERT) - 1,
#ifndef NO_HELP
    .help_string = AT CLICERT "  : Configure client certificate. ",
#endif
    .get = at_return_error,
    .set = at_return_error,
    .run = at_clientcert_run,
  },
				/** AT+CLIKEY **/	
	{
    .string = AT CLIKEY,
		.size_string = sizeof(CLIKEY) - 1,
#ifndef NO_HELP
    .help_string = AT CLIKEY "  : Configure client private key. ",
#endif
    .get = at_return_error,
    .set = at_return_error,
    .run = at_clientkey_run,
  },
				/** AT+UPGRADE **/	
	{
    .string = AT UPGRADE,
